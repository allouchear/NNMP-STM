...
class ElementalModesBlock(Layer):
	...
	def __init__(self, F, initializer_name="GlorotNormal", num_hidden_nodes=None, num_hidden_layers=2, activation_fn=None, seed=None, drop_rate=0.0, use_bias=True, dtype=tf.float32, name="ElementalModesBlock"):
		...
		for i in range(num_hidden_layers):
			self._hidden_layers.append(
				...
				bias_initializer='zeros',name=name+"/Hidden_"+str(i), use_bias=use_bias, dtype=dtype
				))
