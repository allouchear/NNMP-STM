...
def getArguments():
	...
	parser.add_argument("--depthtype", default=0, type=int, help="depthtype : 0=> distance to surface, 1=> distances to atoms , 2 => 2 parameters : distance to plane and z of atoms, 3=> 4 parameters : distance to plane and x,yz, z of atoms. Default=0")
...
def save_model_parameters(args):
	try:
		...
		f.write("--depthtype=" +str(args.depthtype)+"\n")
