...
def getArguments():
	...
	parser.add_argument("--depthtype", default=2, type=int, help="depthtype : 0=> distance to surface, 1=> distances to atoms , 2 => 2 parameters : distance to plane and z of atoms, 3=> 4 parameters : distance to plane and x,yz, z of atoms. Default=2")
