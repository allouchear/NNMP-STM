...
def getArguments():
	...
	parser.add_argument("--depthtype", default=0, type=int, help="depthtype : 0=> distance to surface, 1=> distances to atoms , 2=> 2 parameters : distance to plane and z of atoms")
